                            ...
                            <div class="col-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <input type="number" min="1" step="any" class="form-desconto mb-4" name="Nome"
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        ...
                                        <input type="number" min="0" class="form-resto" name="Nome"
                                ...
                                <div class="row">
                                    <div class="col-12 my-3">
                                        ...
                                        <input type="text" class="form-resto" name="Nome"
