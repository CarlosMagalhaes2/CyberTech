            ...
            <div class="accordion-item">
                ...
                <div id="Portateis" class="accordion-collapse collapse" data-bs-parent="#menu">
                    <div class="accordion-body">
                        <ul class="dropdown">
                            <li><a class="dropdown-item" href="subCategorias.php?SubCategoria='Portáteis Windows'">Portáteis Windows</a></li>
                            <li><a class="dropdown-item" href="subCategorias.php?SubCategoria='Portáteis Apple'">Portáteis Apple</a></li>
