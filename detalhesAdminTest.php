            ...
            <div class="container text-white bg-azul my-3 mr-1">
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="row">
                            <div class="col mt-2">
                                <p class="texto-nome"><?php echo $row["Nome"] ?></p>
                            </div>
                            <div class="col-1">
  ...
  <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z"/>
                        ...
                        <div class="row mb-1">
                            ...
                            ?>
                                ...
                                <p class="preco-detalhes"><?php echo $row["Preco"] ?> €</p>
                            <?php
                            } elseif ($row["Desconto"] == 1) {
                                $precoAtual = $row["Preco"] - $row["ValorDesconto"]
                            ?>
                                <span class="preco-desconto-detalhes"> <?php echo $precoAtual ?> € <span class="badge text-bg-warning-detalhes text-bg-warning">-<?php echo $row["ValorDesconto"] ?> €</span>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <form method="post" action="carrinho.php?ID=<?= $row['ID']; ?>">
                                    <input type="number" class="quantidade-produtos" name="Quantidade" placeholder="1" min="1" value="1" max="<?php echo $row["Stock"] ?>" required <?php if ($row["Stock"] == 0) {                                                                                                                        ?>disabled <?php                                                                                                                                                      } ?>>
                                    <?php if ($row["Stock"] != 0) {
                                    ...
                                    ?>
                                        ...
                                        <button type="submit" name="adicionar" value="adicionar" class="btn btn-adicionar-carrinho"> <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16">
                            ...
                            <div class="col-12">
                                ...
                                ?>
                                    <p class="texto-stock-low">
                                        ...
                                        </svg> Apenas <?php echo $row["Stock"] ?> em stock!
                                    </p>
                                <?php
                                } elseif ($row["Stock"] == 0) {
                                ?>
